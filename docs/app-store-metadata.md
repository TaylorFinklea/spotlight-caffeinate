...
Suggested copy for the Mac App Store listing for `Spotlight Caffeinate`.
...
Optional. Use your product homepage if you have one.
...
If the current app behavior stays the same, the likely App Privacy answer is:

- No, we do not collect data from this app.

Reasoning:

- presets, history, and automation rules are stored locally on the user’s Mac
...
- no analytics, accounts, ads, or remote APIs are integrated

Verify this again before submission if you add analytics, crash reporting, or any hosted service.

## App Review Notes

Use something close to this in the App Review information field:
